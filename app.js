...
function sum(a,b){ //eslint-disable-line
  var mySum = a + b;
  //below is a bit of cheekiness, now it prints "The sum of 4 and 7 is 11." insead of 'The sum of 4 and 7 is 11.'
...
function multiply(a,b){ //eslint-disable-line
  var myMult = a * b;
  var myMsg = 'The product of ' + a + ' and ' + b + ' is ' + myMult + '.';
  return [myMult, myMsg];
}
...
function multiplyArray(testArray){ //eslint-disable-line
  ...
  for(var i = 0; i < testArray.length; i++) {
    ...
    console.log(myArray);
    var multArrayMsg = 'The numbers ' + testArray.toString() + ' have a product of ' + myArray + '.';
  }
  console.log(multArrayMsg);
  return [myArray, multArrayMsg];
}
sumArray(testArray);
